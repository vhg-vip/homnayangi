...
route.get('/favorite', authMiddleware.requireAuth, usercontroller.getFavoriteRecipe);
route.post('/delete-favorite', usercontroller.deleteFavoriteRecipe);
route.post('/add-favorite', usercontroller.addFavoriteRecipe);

route.get('/profile', authMiddleware.requireAuth, usercontroller.getProfile);
